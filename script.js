    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Tlv electronic solutions משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '94d45cab-e4ac-45fa-ad15-f58f1795a95d',
                    name: data.name || '',
                    email: data.email || '',
